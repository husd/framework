...
public class TestHelper {
    ...
    private static EnhancedRandom enhancedRandom = EnhancedRandomBuilder.aNewEnhancedRandomBuilder()
            ...
            .randomize(Long.TYPE, (Randomizer<Long>) () -> TestHelper.anyLong(1000000))
            .randomize(BigDecimal.class, (Randomizer<BigDecimal>) () -> TestHelper.anyBigDecimal())
            .randomize(Integer.TYPE, (Randomizer<Integer>) () -> TestHelper.anyInt(100))
    ...
    public static int anyInt() {
        return Math.abs(RandomUtils.nextInt(0, Integer.MAX_VALUE));
    }
    ...
    public static Long anyLong() {
        return Math.abs(RandomUtils.nextLong(0L, Long.MAX_VALUE));
    }
    ...
    public static <T> Set<T> randomChooseSubCollection(Set<T> source) {
        Set<T> subCollection = source.stream().filter((obj) -> anyBoolean()).collect(Collectors.toSet());
    ...
    public static BigDecimal anyBigDecimal() {
        return BigDecimal.valueOf(Math.abs(RandomUtils.nextDouble(0.0, Double.MAX_VALUE) * anyInt(1000)));
    }
